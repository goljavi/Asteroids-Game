...
public abstract class BaseNode {
	...
	public virtual void DrawConnection() {
		if (parents.Count > 0)
		{
			...
			{
				if (parent != null) SoundEditor.DrawNodeConnection(parent.windowRect, windowRect,
					true, Color.white);
			}
		}
	}
	...
	public virtual BaseNode SetReference(SoundEditor value) {
		reference = value;
		return this;
	}
